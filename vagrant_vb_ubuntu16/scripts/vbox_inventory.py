#!/usr/bin/env python
"""\
https://github.com/siddharthist/vagrant.py
MIT license
...
def generic_hostvars(host_dict):
    ...
    return {
        "ansible_user": host_dict["User"],
        "ansible_ssh_private_key_file": host_dict["IdentityFile"],
        "ansible_port": host_dict["Port"],
        "ansible_host": host_dict["HostName"]
    }
